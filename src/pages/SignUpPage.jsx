            ...
            <Container component="main" maxWidth="sm" sx={{mb: 4}}>
                <Paper variant="outlined" sx={{my: {xs: 3, md: 6}, p: {xs: 2, md: 3}, wordWrap: 'break-word'}}>
                    ...
                    <Grid container spacing={1} justifyContent="flex-start" alignContent="flex-start">
                        ...
                        <Typography color='primary' variant="h6" gutterBottom> Here are 3 ice-breaking questions to get
                            to know you better!</Typography>
                        <Grid container spacing={1} justifyContent="flex-start" alignContent="flex-start"
                              alignItems="stretch" sx={{marginLeft: '1px'}}>
                            <Typography variant="h6"> My favorite food is...</Typography>
                            <Grid item xs={12} sx={{overflowX: 'auto', whiteSpace: 'nowrap'}}>
                                <ToggleButtonGroup color='primary' value={userData.favoriteFood} onChange={handleFood}
                                                   exclusive>
                            ...
                            <Grid item xs={12} sx={{overflowX: 'auto', whiteSpace: 'nowrap'}}>
                                <ToggleButtonGroup color='primary' value={userData.pizzaToppings}
                                                   onChange={handleTopping} exclusive>
                            ...
                            <Grid item xs={12} sx={{overflowX: 'auto', whiteSpace: 'nowrap',}}>
                                <ToggleButtonGroup color='primary' value={userData.hobbies} onChange={handleHobby}
                                                   exclusive>
